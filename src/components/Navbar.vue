<template>
    <div v-if="!collapsed" class="w-64 h-screen bg-gray-900 rounded-md">
        ...
        <div class="absolute bottom-0 left-0 py-4 w-64">
            <!-- Separator -->
            <div class="px-6 pt-4">
                <hr class="border-gray-700"/>
            </div>
            <div class="px-6 pt-4">
                ...
                <!-- <ul class="flex flex-col space-y-2"> -->
                    <!-- <li><div href="" class="inline-block w-full px-4 py-1 text-sm rounded hover:bg-gray-800 hover:text-white">Settings</div></li> -->
                    <!-- <li><a href="" class="inline-block w-full px-4 py-1 text-sm rounded hover:bg-gray-800 hover:text-white">Notifications</a></li> -->
                    <!-- <li><a href="" class="inline-block w-full px-4 py-1 text-sm rounded hover:bg-gray-800 hover:text-white"></a></li> -->
                <!-- </ul> -->
            </div>
            <!-- Hero -->
    ...
    <div v-else class="w-24 h-screen bg-gray-900 rounded-md">
        <div class="px-6 pt-8">
            <div class="flex items-center justify-between">
                <!-- Add a Vue Router later if necessary -->
                <a class="bg-blue-600 p-1.5 rounded-md flex items-center justify-center scale-125">
        ...
        <div class="absolute bottom-0 left-0 py-8 w-24">
            <!-- Separator -->
            <div class="px-5 pt-4">
                <hr class="border-gray-700"/>
            </div>
            <div class="px-7 py-4">
                ...
                <!-- Hero -->
                <div class="pl-7 py-4 bg-[#232529] flex items-center justify-between">
                    <div class="flex items-center">
...
<script setup lang="ts">
    ...
    import { AnOutlinedArrowLeft } from "@kalimahapps/vue-icons/an";
    ...
    import { BxChevronDown, BxChevronRight } from "@kalimahapps/vue-icons/bx";
