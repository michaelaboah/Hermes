    ...
    <div class="flex flex-col h-screen">
      <div class="px-6 pt-8">
        <div class="flex items-center justify-between">
          ...
          <a
            class="bg-blue-600 p-1.5 rounded-md flex items-center justify-center scale-125"
          >
            <PhBoldStackSimple />
          </a>
          <button
            @click="() => (collapsed = !collapsed)"
            class="flex items-center justify-center p-0.5 rounded bg-gray-800 scale-125"
          >
            <BxChevronLeft />
          </button>
        </div>
      ...
      <div class="px-6 pt-4 mt-2">
        ...
        <div class="relative">
          ...
          <input
            class="w-full rounded pl-8 pr-4 py-2.5 text-sm bg-gray-800 text-gray-400 placeholder-gray-500 font-bold"
            type="text"
            placeholder="Search"
          />
        </div>
      ...
      <div class="px-6 pt-4">
        <ul class="flex flex-col space-y-2">
          <li class="relative text-gray-500 hover:text-white">
            ...
            <a
              href="#"
              class="hover:bg-gray-800 inline-block w-full pr-4 py-2 pl-8 rounded text-md"
              >Dashboard</a
            >
          </li>
          <li class="" @click="subDir = !subDir">
            <div
              class="relative text-gray-500 hover:text-white flex justify-between"
            >
              ...
              <div
                class="absolute flex items-center inset-y-0 right-0 pl-2 pr-2"
              >
                <div v-if="subDir">
            ...
            <div v-if="subDir" class="pt-2 pl-4">
              ...
              >
                <li>
                  <a
                    ref="#/Latency"
                    class="inline-block w-full px-4 py-1 text-sm rounded hover:bg-gray-800 hover:text-white"
                    >Latency</a
                  >
                </li>
                <li>
      ...
      <div class="relative bottom-0 left-0 py-4">
        ...
        <!-- Hero -->
        <div
          class="pl-6 pr-4 py-4 mt-6 bg-[#232529] flex items-center justify-between"
        >
  ...
  <div v-else class="w-20 h-screen bg-gray-900 rounded-md">
    <div class="px-6 pt-8">
      <div class="flex items-center justify-between">
        ...
        <button
          @click="() => (collapsed = !collapsed)"
          class="flex items-center justify-center p-0.5 ml-2 rounded hover:bg-gray-800 scale-125"
        >
          <BxChevronRight />
        </button>
      </div>
    ...
    <div class="absolute bottom-0 left-0 py-4 w-20">
      ...
      <!-- Hero -->
      <div
        class="pl-6 py-4 mt-6 bg-[#232529] flex items-center justify-between"
      >
        <div class="flex items-center">
          <div
            class="relative w-8 h-8 rounded-full before:absolute before:w-2 before:h-2 before:bg-green-500 before:rounded-full before:right-0 before:bottom-0 before:ring-1 before:ring-white"
